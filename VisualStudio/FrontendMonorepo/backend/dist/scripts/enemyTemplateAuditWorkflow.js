...
async function logChange(templateId, change) {
...
async function sendEmailNotification(templateId, change) {
...
async function sendWebhookNotification(templateId, change) {
    if (!WEBHOOK_URL)
        return;
...
export async function notifyChange(templateId, change) {
