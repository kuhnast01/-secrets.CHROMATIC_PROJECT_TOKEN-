...
exports.TRACKED_EVENTS = void 0;
exports.summarizeLicenseEvents = summarizeLicenseEvents;
exports.renderSummary = renderSummary;
exports.TRACKED_EVENTS = new Set([
...
function summarizeLicenseEvents(input) {
    ...
    for (const line of input.lines) {
        ...
        if (!row.event || !exports.TRACKED_EVENTS.has(row.event)) {
            continue;
        }
    ...
    return {
        ...
        parsedRows,
        ignoredRows,
        trackedEvents: Array.from(exports.TRACKED_EVENTS.values()),
        counts: {
            byEvent,
            byReason,
            byDay,
...
function renderSummary(result, format) {
    if (format === 'json') {
